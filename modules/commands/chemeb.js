module.exports.config = {
  name: "pthh", // Tên lệnh, được sử dụng trong việc gọi lệnh
  ...
  usages: "pthh [Phương trình]", // Cách sử dụng lệnh
...
module.exports.run = function({ api, event, args, client, __GLOBAL }) {
  //Làm cái gì ở đây tuỳ thuộc vào bạn ¯\_(ツ)_/¯ 
    const chemeb = global.nodemodule["pthh-eb"];
