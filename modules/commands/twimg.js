...
var min = Math.floor(Math.random() * 1);
  ...
  var money = data.money
      if(money < 50000) api.sendMessage("kiếm đủ 50000 đô r xem nha 🦄💜",event.threadID,event.messageID) 
          else {
   Currencies.setData(event.senderID, options = {money: money - 50000})
   var callback = () => api.sendMessage({body:`Mông dú cho các con vợ đây`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID); 
