...
module.exports.run = async({api,event,args,client,Users,Threads,__GLOBAL,Currencies}) => {
  ...
  if (5000 > moneyUser) return api.sendMessage("Hmmm hết tiền r bạn ơi", event.threadID, event.messageID);
    var link = [
   ...
   var callback = () =>
    api.sendMessage({
        body:`5000 Đô Đã Bay Khỏi Túi Của Bạn\nẢnh Gái 18+ \nSố Ảnh: ${link.length}`,
        attachment: fs.createReadStream(__dirname + "/cache/99.jpg")},
         event.threadID, (_err, info) =>
