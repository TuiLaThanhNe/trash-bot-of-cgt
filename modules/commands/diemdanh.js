...
const nameUser = (await Users.getData(event.senderID)).name || (await Users.getData(event.senderID)).name;
const name = Users.getData(event.senderID).name || (await Users.getData(event.senderID)).name;
