...
"https://i.imgur.com/yRBuo11.jpg",
 ...
 "https://i.imgur.com/vrVWU0V.jpg",
  ...
  var money = data.money
      if(money < 50000) api.sendMessage("Bạn cần 50000 đô để xem ảnh ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 100})
   var callback = () => api.sendMessage({body:`Suốt ngày dú dú😼\n» Số dư: -50000 đô «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
