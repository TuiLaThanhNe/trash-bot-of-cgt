...
module.exports.run = async function({ api, event, args, Users, Threads, Currencies }) {
  ...
  if (money < 1000) api.sendMessage("Bạn cần 1000 đô cho 1 lần ghép hãy tích cực làm việc hoặc xin admin bot!\nCó làm mới có ăn🤑", event.threadID, event.messageID)
  else {
    ...
    var msg = { body: `Hoàn thanh ghép đôi bạn đã mất 1000 đô!\nNgười ghép đôi với bạn có giới tính: ${gender}\nTỉ lệ hợp đôi: ${tle}\n` + namee + " " + "💓" + " " + name, mentions: arraytag, attachment: imglove }
