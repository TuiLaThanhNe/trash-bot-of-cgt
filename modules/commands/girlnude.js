...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var money = data.money
      if(money < 500000) api.sendMessage("Nghèo mà thèm gái à , 500000 đô 1 tấm ok",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 500000})
   var callback = () => api.sendMessage({body:`Mấy ba khoái lắm😼\n» Số dư: -500000 đô nha «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
